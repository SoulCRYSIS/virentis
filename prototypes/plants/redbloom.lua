...
data:extend({
  {
    ...
    healing_per_tick = 1,
    factoriopedia_simulation = virentis_plant.simulation("redbloom", "virentis-plain-grass"),
    minable = {
    ...
    autoplace = {
      ...
      probability_expression = "0.1 * voronoi_facet_noise{x = x , y = y , seed0 = map_seed, seed1 = 'redbloom_tree', grid_size = 128, distance_type = 'euclidean', jitter = 0.1 }",
