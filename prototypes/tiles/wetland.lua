...
data:extend({
  ...
  {
    type = "tile",
    name = "virentis-wetland-green-slime",
    subgroup = "virentis-water-tiles",
    collision_mask = tile_collision_masks.shallow_water(),
  ...
  {
    type = "tile",
    name = "virentis-wetland-light-green-slime",
    subgroup = "virentis-water-tiles",
    collision_mask = tile_collision_masks.shallow_water(),
  ...
  --   lowland_fog = true,
  --   effect = "oil",
  --   effect_color = { 74, 65, 69 },
  --   -- effect_color = { 62, 48, 43 },
