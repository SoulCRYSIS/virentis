  ...
  {
    {
      ...
      expression = "slider_rescale(control:virentis_water:frequency, 8) / 8"
    },
    {
      type = "noise-expression",
      name = "virentis_water_size",
      expression = "control:virentis_water:size / 16"
    },
    {
      type = "noise-expression",
      ...
      expression =
      "lerp(clamp(1 - min(0.15 + (virentis_elevation_common / 80), 0.4 + (virentis_elevation_common - 20) / 400), 0, 1), 0.35, min(1, virentis_rockpools_pitrock * 5))"
    },
    {
      type = "noise-expression",
