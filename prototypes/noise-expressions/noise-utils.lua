data:extend(
  {
    ...
    },
    {
      ...
      expression =
      "multioctave_noise{x = x, y = y, persistence = 0.7, seed0 = map_seed, seed1 = 1300005, octaves = 2, input_scale = 1/3}"
    },
    {
      type = "noise-expression",
      name = "virentis_decorative_subtype_mixer", -- small wavelength noise (1 tiles-ish) to make decoratives patchy
      expression =
      "multioctave_noise{x = x, y = y, persistence = 0.7, seed0 = map_seed, seed1 = 1300005, octaves = 2, input_scale = 1/1}"
    },
    {
      type = "noise-expression",
      name = "virentis_decal_noise", -- positive has ridge bias, mainly for ground decals, mycelium, veins
      expression =
      "0.6 * multioctave_noise{x = x, y = y, persistence = 0.7, seed0 = map_seed, seed1 = 1500, octaves = 2, input_scale = 1/16, output_scale = 0.5}\z
    ...
    },
    {
      ...
      expression =
      "0.6 * multioctave_noise{x = x, y = y, persistence = 0.7, seed0 = map_seed, seed1 = 5500, octaves = 2, input_scale = 1/12, output_scale = 0.5}\z
    ...
    },
    {
      ...
      expression =
      "0.6 * multioctave_noise{x = x, y = y, persistence = 0.7, seed0 = map_seed, seed1 = 3500, octaves = 2, input_scale = 1/10, output_scale = 0.5}\z
    ...
    },
    {
      ...
      expression =
      "0.6 * multioctave_noise{x = x, y = y, persistence = 0.7, seed0 = map_seed, seed1 = 7500, octaves = 2, input_scale = 1/8, output_scale = 0.5}\z
    ...
    },
    {
      ...
      expression =
      "0.6 * multioctave_noise{x = x, y = y, persistence = 0.7, seed0 = map_seed, seed1 = 7500, octaves = 2, input_scale = 1/6, output_scale = 0.5}\z
        + 0.3 - abs(multioctave_noise{x = x, y = y, persistence = 0.7, seed0 = map_seed, seed1 = 8500, octaves = 2, input_scale = 1/6})"
    },
    {
      type = "noise-function",
      name = "grid_random_shift",
      parameters = { "spacing", "shift_max", "seed" },
      expression = "(shifted_x % spacing == 0) & (shifted_y % spacing == 0)",
      local_expressions = {
        shifted_x = "x + floor(voronoi_cell_id{x = x, y = y, seed0 = map_seed, seed1 = seed, grid_size = spacing, distance_type = 'manhattan', jitter = 0} * shift_max)",
        shifted_y = "y + floor(voronoi_cell_id{x = x, y = y, seed0 = map_seed + 1, seed1 = seed, grid_size = spacing, distance_type = 'manhattan', jitter = 0} * shift_max)",
      }
    },
  })
