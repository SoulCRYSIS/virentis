...
Fish cooking production line, extend from [Fishing dock](https://mods.factorio.com/mod/fishing-dock)
...
- Spores can be produce a lot by cooking machines, so you should prepare defense or be efficient
...
- While it possible to start here with only a biochamber, but it really hard and didn't designed for, so you may want to import basic machines like Assembling machine, Modules, Bots.
